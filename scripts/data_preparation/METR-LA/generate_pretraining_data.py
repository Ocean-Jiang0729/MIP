# -*- coding: utf-8 -*-
"""
Created on Wed Aug  7 14:53:39 2024
...
def generate_data(args: argparse.Namespace):
    ...
    data_norm = scaler(data, output_dir, train_index, seq_len, seq_len, norm_each_channel=norm_each_channel)
    ...
    print("AAA processed_data", processed_data.shape)
    # save data
    index = {}
    index["train"] = train_index
    index["valid"] = valid_index
    index["test"] = test_index
    with open(output_dir + "/index_in_{0}_out_{1}_rescale_{2}.pkl".format(seq_len, seq_len, if_rescale), "wb") as f:
        pickle.dump(index, f)

    data = {}
    data["processed_data"] = processed_data
    with open(output_dir + "/data_in_{0}_out_{1}_rescale_{2}.pkl".format(seq_len, seq_len, if_rescale), "wb") as f:
        pickle.dump(data, f)
    # copy adj
...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = "datasets/" + DATASET_NAME + "pretrain"
