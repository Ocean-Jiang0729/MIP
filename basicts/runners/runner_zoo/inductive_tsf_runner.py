...
from ..base_inductive_tsf_runner import InductiveTimeSeriesForecastingRunner


class InductiveSimpleTimeSeriesForecastingRunner(InductiveTimeSeriesForecastingRunner):
