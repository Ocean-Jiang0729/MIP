...
def masked_mae_V(prediction: torch.Tensor, target: torch.Tensor, null_val: float = np.nan) -> torch.Tensor:
    """Masked mean absolute error.
...
def masked_mae_v(prediction: torch.Tensor, target: torch.Tensor, lamada1:float,null_val: float = np.nan) -> torch.Tensor:
    """Masked mean absolute error.
    ...
    return torch.mean(loss)+lamada1*torch.var(loss)
...
def masked_rmse_V(prediction: torch.Tensor, target: torch.Tensor, null_val: float = np.nan) -> torch.Tensor:
    """root mean squared error.
...
def masked_mape_V(prediction: torch.Tensor, target: torch.Tensor, null_val: float = 0.0) -> torch.Tensor:
    """Masked mean absolute percentage error.
